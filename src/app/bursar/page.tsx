          ...
          <aside className="fixed inset-y-0 left-0 w-72 max-w-[85vw] bg-card-custom border-r border-border-custom flex flex-col justify-between shadow-2xl p-6 z-10 animate-in slide-in-from-left duration-300">
            <div className="space-y-6">
              ...
              <nav className="space-y-1.5">
                ...
                <button
                  onClick={() => { setActiveTab('log-payments'); setMobileMenuOpen(false); }}
                  className={`flex items-center space-x-3 w-full px-4 py-3 rounded-xl text-xs font-bold transition-all ${
                ...
                <button
                  onClick={() => { setActiveTab('debtors'); setMobileMenuOpen(false); }}
                  className={`flex items-center space-x-3 w-full px-4 py-3 rounded-xl text-xs font-bold transition-all ${
                    activeTab === 'debtors'
                      ? 'bg-secondary/15 text-secondary'
                      : 'text-muted-fg-custom hover:bg-muted-custom hover:text-fg-custom'
                ...
                <button
                  onClick={() => { setActiveTab('fees-structure'); setMobileMenuOpen(false); }}
                  className={`flex items-center space-x-3 w-full px-4 py-3 rounded-xl text-xs font-bold transition-all ${
            ...
            <div className="border-t border-border-custom pt-4 space-y-4">
              <div className="text-xs">
                ...
                <span className="block text-[10px] text-muted-fg-custom font-semibold uppercase">Bursary Officer</span>
              </div>
              <button
        ...
        <div className={`p-4 ${sidebarCollapsed ? 'space-y-6' : 'p-6 space-y-8'}`}>
            ...
            <div className="flex items-center space-x-3 overflow-hidden">
              ...
              {!sidebarCollapsed && (
                <div className="truncate">
                  <span className="block font-black text-xs tracking-wider uppercase text-primary dark:text-white truncate">Bursary Portal</span>
          ...
          <nav className="space-y-1">
            <button
              ...
              title={sidebarCollapsed ? 'Financial Overview' : undefined}
            ...
            <button
              ...
              title={sidebarCollapsed ? 'Log Student Payment' : undefined}
              className={`flex items-center ${sidebarCollapsed ? 'justify-center px-2' : 'space-x-3 px-4'} w-full py-3 rounded-xl text-xs font-bold transition-all ${
                activeTab === 'log-payments'
                  ? 'bg-secondary/15 text-secondary'
                  : 'text-muted-fg-custom hover:bg-muted-custom hover:text-fg-custom'
            ...
            >
              <CreditCard className="w-4 h-4 flex-shrink-0" />
              {!sidebarCollapsed && <span>Log Student Payment</span>}
            </button>

            <button
              onClick={() => setActiveTab('debtors')}
              title={sidebarCollapsed ? 'Debtors Ledger' : undefined}
              className={`flex items-center ${sidebarCollapsed ? 'justify-center px-2' : 'space-x-3 px-4'} w-full py-3 rounded-xl text-xs font-bold transition-all ${
                activeTab === 'debtors'
                  ? 'bg-secondary/15 text-secondary'
                  : 'text-muted-fg-custom hover:bg-muted-custom hover:text-fg-custom'
            ...
            >
              <Users className="w-4 h-4 flex-shrink-0" />
              {!sidebarCollapsed && <span>Debtors Ledger</span>}
            </button>

            <button
              onClick={() => setActiveTab('fees-structure')}
              title={sidebarCollapsed ? 'Fee Structure' : undefined}
              className={`flex items-center ${sidebarCollapsed ? 'justify-center px-2' : 'space-x-3 px-4'} w-full py-3 rounded-xl text-xs font-bold transition-all ${
                activeTab === 'fees-structure'
                  ? 'bg-secondary/15 text-secondary'
                  : 'text-muted-fg-custom hover:bg-muted-custom hover:text-fg-custom'
            ...
            >
              <Sliders className="w-4 h-4 flex-shrink-0" />
              {!sidebarCollapsed && <span>Fee Structure</span>}
            </button>
            ...
            <>
              <div className="flex items-center justify-between">
                <div className="text-xs truncate">
                  ...
                  <span className="block text-[10px] text-muted-fg-custom font-semibold uppercase truncate">Bursary Officer</span>
                </div>
              </div>
              <button
                onClick={handleLogout}
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-card-custom border-b border-border-custom px-4 sm:px-6 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            <span className="text-[10px] text-muted-fg-custom font-bold uppercase hidden lg:block">Ledger: Manual tracking only</span>
            <ThemeToggle />
            <button
              onClick={handleLogout}
